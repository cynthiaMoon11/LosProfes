...
namespace LosProfes.Controllers
{
    public class ProfesorMateriasController : Controller
    {
        ...
        {
            var applicationDbContext = _context.ProfesorMateria.Include(p => p.Materia).Include(p => p.Profesor);
        ...
        public async Task<IActionResult> Create([Bind("Id,ProfesorId,MateriaId")] ProfesorMateria profesorMateria)
        {
            ...
            ViewData["MateriaId"] = new SelectList(_context.Materia, "Id", "Id", profesorMateria.MateriaId);
            ViewData["ProfesorId"] = new SelectList(_context.Profesor, "Id", "Id", profesorMateria.ProfesorId);
            return View(profesorMateria);
        }
