...
namespace LosProfes.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    if (Input.TipoUsuario == "padre")
                    {
                        await _userManager.AddToRoleAsync(user, "padre");
                    }
                    else
                    {
                        await _userManager.AddToRoleAsync(user, "profe");
                    }
                    _logger.LogInformation("User created a new account with password.");
